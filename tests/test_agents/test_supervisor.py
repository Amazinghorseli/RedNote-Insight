...
class TestSupervisor:
    ...
    def test_decide_with_empty_strategies(self):
        ...
        from src.agents.supervisor import Supervisor
        # 用 MagicMock 创建 mock LLM，避免 Pydantic 限制
        mock_llm = MagicMock()
        mock_llm.invoke.return_value.content = "  hybrid  "
    ...
    def test_decide_falls_back_to_hybrid(self):
        ...
        from src.agents.supervisor import Supervisor
        mock_llm = MagicMock()
        mock_llm.invoke.return_value.content = "invalid_strategy"
    ...
    def test_decide_returns_valid_strategy(self):
        ...
        from src.agents.supervisor import Supervisor
        mock_llm = MagicMock()
        mock_llm.invoke.return_value.content = "vector"
